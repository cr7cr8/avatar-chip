...
var _excluded = ["size", "personName"],
    _excluded2 = ["size", "personName", "label"],
    _excluded3 = ["classes", "personName", "src"],
    _excluded4 = ["classes", "size", "personName", "avatarProps"],
    _excluded5 = ["src"];
...
var breakpoints = (0, _createBreakpoints["default"])({}); // const withStylesProps = (makingStylesFn) => {
//   return (Component) => {
...
var makingStyleObj = function makingStyleObj() {
  ...
  return {
    avatarSize: function avatarSize(_ref2) {
      var _ref2$size = _ref2.size,
          size = _ref2$size === void 0 ? "40px" : _ref2$size,
          personName = _ref2.personName,
    ...
    chipSize: function chipSize(_ref3) {
...
var AvatarLogo_ = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AvatarLogo_, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          src = _this$props.src,
          rest = _objectWithoutProperties(_this$props, _excluded3); //const src_ = personName === "bank" ? bankLogo : "data:image/svg+xml;base64," + btoa(personName && multiavatar(personName))
  ...
  return AvatarLogo_;
}(_react.Component); //export const AvatarLogo = withStylesProps(makingStyleObj)(AvatarLogo_);


var AvatarLogo = (0, _styles.withStyles)(makingStyleObj)(AvatarLogo_);
...
var AvatarChip_ = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(AvatarChip_, [{
    ...
    value: function render() {
      ...
      var _ref4 = this.props.avatarProps || {},
          src = _ref4.src,
          avatarRest = _objectWithoutProperties(_ref4, _excluded5);
  ...
  return AvatarChip_;
}(_react.Component); //export  const AvatarChip = withStylesProps(makingStyleObj)(AvatarChip_);


var AvatarChip = (0, _styles.withStyles)(makingStyleObj)(AvatarChip_);
