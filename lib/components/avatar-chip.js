...
var _excluded = ["lgTextSizeArr", "textSizeArr", "breakpointsAttribute", "multiplyArr"],
    ...
    _excluded5 = ["classes", "personName", "src"],
    _excluded6 = ["classes", "theme", "size", "personName", "avatarProps", "logoOn", "labelOn", "children"],
    _excluded7 = ["src"];
  ...
  return {
    ...
    typoUpCss: function typoUpCss(_ref5) {
      ...
      return _objectSpread({
        ...
        margin: 0,
        padding: 0
      }, breakpointsAttribute(["fontSize", multiplyArr(size_, 65 / 100)]));
    },
    typoDownCss: function typoDownCss(_ref6) {
      ...
      return _objectSpread({
        ...
        margin: 0,
        padding: 0
      }, breakpointsAttribute(["fontSize", multiplyArr(size_, 35 / 100)]));
    },
...
var TwoLineLabel_ = /*#__PURE__*/function (_Component) {
  ...
  _createClass(TwoLineLabel_, [{
    ...
    value: function render() {
      ...
      var allClassNamesTop = (0, _classnames["default"])((_classNames = {}, _defineProperty(_classNames, typoUpCss, true), _defineProperty(_classNames, className, true), _classNames));
      var allClassNamesDown = (0, _classnames["default"])((_classNames2 = {}, _defineProperty(_classNames2, typoDownCss, true), _defineProperty(_classNames2, className, true), _classNames2));
...
var TwoLineLabelWithStyled = (0, _styledComponents["default"])(TwoLineLabel_).withConfig({
  ...
  return _objectSpread({}, props.cssStyle);
});
  ...
  _createClass(AvatarChip_, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props3, _excluded6);

      var _ref7 = this.props.avatarProps || {},
          src = _ref7.src,
          avatarRest = _objectWithoutProperties(_ref7, _excluded7);
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        label: personName
      }, rest, this.props.label && this.props.label.type && this.props.label.type.Naked && this.props.label.type.Naked.name === "TwoLineLabel_" && labelOn && {
